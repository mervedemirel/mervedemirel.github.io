      ...
      transitions: [{
        ...
        beforeLeave: function beforeLeave(data) {
          ...
          return caseLTL.to('body', {
            ...
            // overflow: 'hidden',
            pointerEvents: 'none'
          }).to('.card:not(.project-to), .cta, .footer, .hero, .secret-section', {
            autoAlpha: 0,
            duration: 0.5,
            ease: 'cubicOut'
          }, 0).to('.project-to h2', {
      ...
      (function ($) {
        ...
        $(document).ready(function () {
          ...
          if ($('.intro p strong, .cta a, .contact-info p strong, .c-circle').length) {
            var block = $('.intro p strong, .cta a, .c-circle, .contact-info p strong'); // staticCirc = $('.contact-info p strong');
